...
def draw_circles1():
    ...
    print('--------------------------------------------------')
    thirdWindow = rg.RoseWindow(400,400)
    for k in range(21):
        center_point1 = rg.Point(200, 200)
        a = rg.Circle(center_point1, k*10)
        a.attach_to(thirdWindow)
    thirdWindow.render()
    thirdWindow.close_on_mouse_click()
...
def draw_circles2():
    ...
    print('--------------------------------------------------')
    fourthWindow = rg.RoseWindow(400,400)
    for k in range(18):
        center_point2 = rg.Point(50+20*k, 100)
        b = rg.Circle(center_point2, 10)
        b.fill_color = 'blue'
        b.attach_to(fourthWindow)
    fourthWindow.render()
    fourthWindow.close_on_mouse_click()
...
def draw_circles3():
    ...
    print('--------------------------------------------------')
    fithWindow = rg.RoseWindow(300, 300)
    for k in range(100):
        center_point3 = rg.Point(200,150)
        c = rg.Circle(center_point3, k+1)
        c.attach_to(fithWindow)
    fithWindow.render()
    fithWindow.close_on_mouse_click()
...
def draw_cosines_and_sines():
    ...
    print('--------------------------------------------------')
    sixthWindow = rg.RoseWindow(400, 400)
    for k in range(100):
        center_point3 = rg.Point(200 + 80*math.cos(k), 200+80*math.sin(k))
        d = rg.Circle(center_point3, 10)
        d.attach_to(sixthWindow)
    sixthWindow.render()
    sixthWindow.close_on_mouse_click()
